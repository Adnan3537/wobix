...
function ContactSection() {
    ...
    return (
        <div className='bg-[#F8F8F8] '>
            <div className='wrapper  pt-20 pb-20 '>
                <div className=' justify-between flex flex-col md:flex-row'>
                    <div>
                        <h4 className='md:mb-20 mb-10 text-[#0000004D]'>Contact Us</h4>
                        <h2 className='mb-5 text-[50px] '>Let’s be in touch</h2>
                        <div className='justify-center items-center space-y-5 '>
                            <h3 className='font-semibold'>Contact Information</h3>
                            <div className='flex items-center gap-2'><svg width="14" height="20" viewBox="0 0 14 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='p-6 rounded-lg shadow-md md:mt-0 mt-10'>
